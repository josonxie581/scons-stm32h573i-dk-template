/**
  ...
  *                - Set the initial PC == Reset_Handler, //设置初始化PC指针指向Reset_Handler函数
  *                - Set the vector table entries with the exceptions ISR address, //设置异常中断服务函数地址
  *                - Configure the clock system //配置时钟系统
  *                - Branches to main in the C library (which eventually
  *                  calls main()). //跳转到C库中的main函数
  *            After Reset the Cortex-M33 processor is in Thread mode, //复位后，Cortex-M33处理器处于线程模式
